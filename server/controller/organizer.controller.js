...
exports.addHackathonEvent = async (req, res) => {
  const {
    ...
    hackathonName: hackathon_name = null,
    hackathonType: hackathon_type = null,
    finalEventDate: final_date = null,
    venue: location = null,
    country = null,
    phoneNumber: phone_no = null,
    email = null,
    proposalPDF: proposal_pdf = null,
    logo = null,
  } = req.body;
  ...
  try {
    ...
    const sql = `
          ...
          (organization_name, hackathon_name, hackathon_type, final_date, location, country, phone_no, email, proposal_pdf, logo)
          VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)
      `;
